...
const page = () => {
  return (
    <>
      <div className="flex justify-center items-center py-8 xl:py-16 lg:py-14 md:py-12 sm:py-10">
        <div className="flex flex-col gap-5 xl:gap-12 lg:gap-10 md:gap-8 sm:gap-6 w-[90%] xl:w-[73%] lg:w-[78%] md:w-[84%] sm:w-[86%]">
          <div className="flex flex-col xl:gap-7 lg:gap-5 md:gap-3 gap-2">
            <h1 className="text-[20px] xl:text-[38px] lg:text-[34px] md:text-[30px] sm:text-[28px] text-[#4d1e5e] text-left font-bold">
              Maasta Terms and Conditions
            </h1>
            <p className="text=[#dedfe2] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] font-normal leading-6 xl:leading-8 lg:leading-7 md:leading-7 sm:leading-7">
              ...
              REMEDIES.
              <br />
              Last Revised: 2022-10-31 08:14:00
            </p>
          </div>
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            <h1 className="text-[14px] xl:text-[28px] lg:text-[24px] md:text-[20px] sm:text-[16px] text-[#4d1e5e] text-left font-bold">
              1. OVERVIEW
            </h1>
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              This Terms of Service Agreement ("Agreement") is entered into by
              and between Maasta, registered address 14/21 perumapalyam, India
              ("Company") and you, and is made effective as of the date of your
              use of this website Maasta ("Site") or the date of electronic
              acceptance. This Agreement sets forth the general terms and
              conditions of your use of the Maasta as well as the products
              and/or services purchased or accessed through this Site (the
              "Services").Whether you are simply br /owsing or using this Site
              or purchase Services, your use of this Site and your electronic
              acceptance of this Agreement signifies that you have read,
              understand, acknowledge and agree to be bound by this Agreement
              our Privacy policy. The terms "we", "us" or "our" shall refer to
              Company. The terms "you", "your", "User" or "customer" shall refer
              to any individual or entity who accepts this Agreement, uses our
              Site, has access or uses the Services. Nothing in this Agreement
              ...
              THIS AGREEMENT AS LAST REVISED, DO NOT USE (OR CONTINUE TO USE)
          ...
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              Services found under the laws of the India or other applicable
              jurisdiction.
              <br />
              <br />
          ...
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              other person or entity, or br /eaches any duty of confidentiality
              ...
              where expressly authorized by Company, Modify or alter any part of
          ...
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              ("Companies Content"), are owned by or licensed to Maasta in
              ...
              reproduced, distributed, transmitted, br /oadcast, displayed,
          ...
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              you may request a refund under the terms and conditions of our
              Refund Policy which can be accessed here.
            </p>
          </div>
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            <h1 className="text-[14px] xl:text-[28px] lg:text-[24px] md:text-[20px] sm:text-[16px] text-[#4d1e5e] text-left font-bold">
          ...
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              TamilNadu, to the exclusion of conflict of law rules..
            </p>
          </div>
          <div className="flex flex-col gap-3 xl:gap-7 lg:gap-6 md:gap-5 sm:gap-4">
            <h1 className="text-[14px] xl:text-[28px] lg:text-[24px] md:text-[20px] sm:text-[16px] text-[#4d1e5e] text-left font-bold">
            ...
            <p className="text-[#495261] text-[12px] xl:text-lg lg:text-lg md:text-md sm:text-[14px] text-left leading-6 xl:leading-8 lg:leading-7">
              ...
              in India, TamilNadu, and judgment on the arbitration award may be
